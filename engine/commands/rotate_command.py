...
class RotateEntityCommand(Command):
    """Replace entities with their rotated geometry and restore them on undo."""
...
class RotateCommand(RotateEntityCommand):
    """Backward-compatible alias for the V2 rotate command."""
